...
import { FileText, Lock, User, Mail, ArrowRight } from 'lucide-react';
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 via-background-dark to-slate-900 relative overflow-hidden">
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-primary-600 rounded-full blur-[120px] opacity-20 animate-pulse-slow"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-purple-600 rounded-full blur-[120px] opacity-20 animate-pulse-slow delay-1000"></div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join Smart PDF Assistant today</p>
        </div>
